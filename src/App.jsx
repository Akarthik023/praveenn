          ...
          {categories.map(cat => (
            <button
              ...
              style={{
                ...
                border: `1px solid ${activeCat === cat ? 'var(--primary)' : 'rgba(255,255,255,0.1)'}`,
          ...
          <AnimatePresence>
            {filteredMenu.map(item => (
              <motion.div
                ...
                key={item.id}
                style={{ backgroundColor: 'var(--surface-card)', borderRadius: '20px', overflow: 'hidden', boxShadow: 'var(--shadow-md)', transition: 'transform 0.3s', border: '1px solid rgba(255,255,255,0.06)' }}
          ...
          {["Breakfast", "Lunch", "Dinner", "Snacks", "Dessert"].map(meal => (
            <button
              ...
              style={{
                ...
                border: `1px solid ${activeMeal === meal ? 'var(--primary)' : 'rgba(255,255,255,0.1)'}`,
              }}
            >
              {meal}
            </button>
