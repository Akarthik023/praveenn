...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'py-3' : 'py-5'}`} style={{ top: 0, left: 0, right: 0, background: scrolled ? 'rgba(28, 24, 21, 0.95)' : 'linear-gradient(to bottom, rgba(10,8,7,0.9) 0%, rgba(10,8,7,0) 100%)', backdropFilter: scrolled ? 'blur(12px)' : 'none', borderBottom: scrolled ? '1px solid rgba(255,255,255,0.1)' : 'none' }}>
      <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <a href="#" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <img src="/assets/logo-aalayaa.png" alt="Hotel Aalaya" className="nav-logo" style={{ height: '90px', width: 'auto', padding: '5px 0', filter: 'drop-shadow(0 2px 4px rgba(0,0,0,0.5))' }} />
        </a>
...
const Hero = () => {
  return (
    <section id="home" style={{ position: 'relative', minHeight: '100dvh', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', zIndex: 1, paddingTop: 'var(--nav-height)' }}>
      ...
      <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to right, rgba(20,17,15,0.95) 0%, rgba(20,17,15,0.6) 60%, rgba(20,17,15,0.3) 100%)', zIndex: -1 }} />
      ...
      <div className="container hero-grid" style={{ position: 'relative', zIndex: 1, color: 'white', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '40px', alignItems: 'center' }}>
        <motion.div 
          initial="hidden" 
          animate="visible" 
          variants={{
        ...
        >
          ...
          <motion.h1 variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { duration: 1, ease: [0.16, 1, 0.3, 1] } } }} className="font-playfair" style={{ fontSize: 'clamp(2rem, 6vw, 5rem)', lineHeight: 1.1, marginBottom: '20px', textShadow: '0 10px 30px rgba(0,0,0,0.5)' }}>
        ...
        >
          <motion.div 
            ...
            className="glass-dark" 
            style={{ padding: '30px', borderRadius: '24px', maxWidth: '380px', border: '1px solid rgba(99, 197, 0, 0.2)', background: 'linear-gradient(135deg, rgba(38,33,28,0.8) 0%, rgba(38,33,28,0.4) 100%)', backdropFilter: 'blur(20px)' }}
          >
            ...
            <div style={{ borderRadius: '16px', overflow: 'hidden', marginBottom: '20px', position: 'relative' }}>
              ...
              />
              <div style={{ position: 'absolute', top: '12px', right: '12px', background: 'rgba(10,8,7,0.6)', backdropFilter: 'blur(8px)', padding: '6px 12px', borderRadius: '20px', fontSize: '0.85rem', fontWeight: 600, border: '1px solid rgba(255,255,255,0.2)' }}>
                Chef's Pick
              </div>
            </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '60px', alignItems: 'center' }}>
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <div style={{ position: 'relative' }}>
              ...
              <div className="glass-dark" style={{ position: 'absolute', bottom: '-20px', right: '-20px', padding: '24px', borderRadius: '16px', maxWidth: '200px', zIndex: 10 }}>
      ...
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '30px' }}>
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }} style={{ gridColumn: '1 / -1', height: '400px', borderRadius: '24px', overflow: 'hidden', position: 'relative' }}>
            ...
            <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to top, rgba(10,8,7,0.8), transparent)', display: 'flex', alignItems: 'flex-end', padding: '40px' }}>
...
const Stats = () => {
  ...
  return (
    <section style={{ backgroundColor: 'var(--surface-strong)', borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)', color: 'white', padding: '80px 0' }}>
      <div className="container">
