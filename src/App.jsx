...
export default function App() {
      ...
      nav.innerHTML = `
        <a class="brand" href="#top" aria-label="${siteConfig.hotel.name} home">
          ...
          <div class="brand-copy">
            <strong>${siteConfig.hotel.name}</strong>
            <span>${siteConfig.hotel.tagline}</span>
          </div>
        </a>
  ...
  <main>
    ...
    <section className="section dishes" id="signature_dishes">
      <div className="shell">
  ...
  <footer className="site-footer">
    <div className="shell footer-row">
      <div className="footer-brand">
        <img src="./assets/logo-aalayaa.png" alt="Aalayaa logo" />
        <div>
          <strong>Aalayaa</strong>
          <div>Authentic Taste of Tradition</div>
        </div>
      </div>
