...
const menuItems = [
  { id: 1, name: "Special Ghee Masala Dosa", category: "South Indian", price: "₹120", desc: "Golden crisp dosa roasted in pure ghee.", image: "/assets/site/dish-crispy-strips.jpg" },
  { id: 2, name: "South Indian Meals", category: "Meals", price: "₹250", desc: "A grand feast featuring rice, sambar, rasam, kootu, and sweet.", image: "/assets/site/dish-mutton-chukka.jpg" },
  { id: 3, name: "Paneer Butter Masala", category: "North Indian", price: "₹220", desc: "Rich and creamy cottage cheese curry.", image: "/assets/site/dish-sea-fire.jpg" },
  { id: 4, name: "Mushroom Pepper Fry", category: "Starters", price: "₹180", desc: "Spicy and aromatic mushroom fry.", image: "/assets/site/dish-pepper-fry.jpg" },
  { id: 5, name: "Veg Prawn 65", category: "Starters", price: "₹190", desc: "Crispy plant-based prawns.", image: "/assets/site/dish-chilli-bites.jpg" },
  { id: 6, name: "Kesari Delight", category: "Desserts", price: "₹90", desc: "Traditional sweet notes with a rich glaze.", image: "/assets/site/dish-mushroom-roast.jpg" },
];

const categories = ["All", "South Indian", "North Indian", "Meals", "Starters", "Desserts"];
...
const galleryImages = [
  "/assets/site/dish-pepper-fry.jpg",
  "/assets/site/dish-crispy-strips.jpg",
  "/assets/site/dish-mutton-chukka.jpg",
  "/assets/site/dish-sea-fire.jpg",
  "/assets/site/dish-chilli-bites.jpg",
  "/assets/site/dish-mushroom-roast.jpg",
];
...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'py-3' : 'py-5'}`} style={{ top: 0, left: 0, right: 0, background: scrolled ? 'rgba(17, 24, 39, 0.95)' : 'linear-gradient(to bottom, rgba(0,0,0,0.9) 0%, rgba(0,0,0,0) 100%)', backdropFilter: scrolled ? 'blur(12px)' : 'none', borderBottom: scrolled ? '1px solid rgba(255,255,255,0.1)' : 'none' }}>
      <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <a href="#" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <img src="/assets/logo-aalayaa.png" alt="Hotel Aalaya" style={{ height: '90px', width: 'auto', padding: '5px 0', filter: 'drop-shadow(0 2px 4px rgba(0,0,0,0.5))' }} />
        </a>

        {/* Desktop Menu */}
        <div style={{ display: 'flex', gap: '2rem', alignItems: 'center', color: 'white' }} className="desktop-menu">
          {['Home', 'About', 'Ambience', 'Menu', 'Gallery'].map((item) => (
        ...
        {/* Mobile Toggle */}
        <button className="mobile-toggle" onClick={() => setIsOpen(!isOpen)} style={{ display: 'none', background: 'transparent', border: 'none', color: 'white' }}>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            style={{ position: 'absolute', top: '100%', left: 0, width: '100%', padding: '20px', display: 'flex', flexDirection: 'column', gap: '16px', boxShadow: '0 10px 25px rgba(0,0,0,0.1)', color: 'white' }}
          >
            {['Home', 'About', 'Ambience', 'Menu', 'Gallery', 'Events', 'Contact'].map((item) => (
              <a key={item} href={`#${item.toLowerCase()}`} onClick={() => setIsOpen(false)} style={{ fontSize: '1.1rem', fontWeight: 500, padding: '10px 0', borderBottom: '1px solid rgba(255,255,255,0.1)', color: item === 'Events' ? 'var(--accent)' : 'inherit', display: 'flex', alignItems: 'center', gap: '8px' }}>
                {item === 'Events' && <Star size={18} />}
                {item === 'Events' ? 'Party & Corporate Events' : item}
              </a>
            ))}
          </motion.div>
        )}
...
const Hero = () => {
  return (
    <section id="home" style={{ position: 'relative', height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', zIndex: 1 }}>
      <div style={{ position: 'absolute', inset: 0, zIndex: -2, backgroundColor: '#050505', overflow: 'hidden' }}>
        <motion.div 
      ...
      <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to right, rgba(0,0,0,0.95) 0%, rgba(0,0,0,0.6) 60%, rgba(0,0,0,0.3) 100%)', zIndex: -1 }} />
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1, color: 'white', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '40px', alignItems: 'center' }}>
        <motion.div 
          initial="hidden" 
          animate="visible" 
          variants={{
        ...
        >
          <motion.img variants={{ hidden: { opacity: 0, scale: 0.8, filter: 'blur(10px)' }, visible: { opacity: 1, scale: 1, filter: 'blur(0px)', transition: { duration: 1, ease: "easeOut" } } }} src="/assets/logo-aalayaa.png" alt="Hotel Aalaya Logo" className="logo-glow" style={{ height: '110px', marginBottom: '24px', filter: 'drop-shadow(0 4px 12px rgba(0,0,0,0.5))' }} />
          ...
          <motion.h1 variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { duration: 1, ease: [0.16, 1, 0.3, 1] } } }} className="font-playfair" style={{ fontSize: 'clamp(3rem, 6vw, 5rem)', lineHeight: 1.1, marginBottom: '20px', textShadow: '0 10px 30px rgba(0,0,0,0.5)' }}>
            Welcome to <br/><span style={{ color: 'var(--primary)', display: 'inline-block', marginTop: '10px' }}>Hotel Aalaya</span>
          </motion.h1>
          
          <motion.p variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { duration: 0.8, ease: "easeOut" } } }} style={{ fontSize: '1.2rem', color: 'rgba(255,255,255,0.85)', maxWidth: '500px', marginBottom: '36px', lineHeight: 1.7, fontWeight: 300 }}>
          ...
          <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { duration: 0.8, ease: "easeOut" } } }} style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
            ...
            <motion.a href="#menu" className="btn btn-outline" whileHover={{ scale: 1.05, backgroundColor: 'rgba(255,255,255,0.1)' }} whileTap={{ scale: 0.95 }} style={{ color: 'white', borderColor: 'rgba(255,255,255,0.4)', padding: '16px 32px', fontSize: '1.05rem', backdropFilter: 'blur(5px)' }}>View Menu</motion.a>
          </motion.div>
        </motion.div>
        ...
        >
          <motion.div 
            ...
            className="glass-dark" 
            style={{ padding: '30px', borderRadius: '24px', maxWidth: '380px', border: '1px solid rgba(99, 197, 0, 0.2)', background: 'linear-gradient(135deg, rgba(17,24,39,0.8) 0%, rgba(17,24,39,0.4) 100%)', backdropFilter: 'blur(20px)' }}
          >
            ...
            <div style={{ borderRadius: '16px', overflow: 'hidden', marginBottom: '20px', position: 'relative' }}>
              ...
              />
              <div style={{ position: 'absolute', top: '12px', right: '12px', background: 'rgba(0,0,0,0.6)', backdropFilter: 'blur(8px)', padding: '6px 12px', borderRadius: '20px', fontSize: '0.85rem', fontWeight: 600, border: '1px solid rgba(255,255,255,0.2)' }}>
                Chef's Pick
              </div>
            </div>
            <h4 style={{ fontSize: '1.25rem', marginBottom: '10px', fontWeight: 600 }}>Mushroom Pepper Roast</h4>
            <p style={{ fontSize: '0.95rem', color: 'rgba(255,255,255,0.7)', marginBottom: '20px', lineHeight: 1.5 }}>Freshly picked mushrooms tossed with ground pepper and authentic South Indian spices.</p>
            <a href="#menu" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 16px', background: 'rgba(255,255,255,0.05)', borderRadius: '12px', transition: 'background 0.3s' }} onMouseEnter={(e) => e.currentTarget.style.background = 'rgba(99,197,0,0.1)'} onMouseLeave={(e) => e.currentTarget.style.background = 'rgba(255,255,255,0.05)'}>
              <span style={{ fontWeight: 600, color: 'white' }}>Order Now</span>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '60px', alignItems: 'center' }}>
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <div style={{ position: 'relative' }}>
              ...
              <div className="glass" style={{ position: 'absolute', bottom: '-20px', right: '-20px', padding: '24px', borderRadius: '16px', maxWidth: '200px' }}>
                <p className="font-playfair" style={{ fontSize: '2rem', color: 'var(--primary)', marginBottom: '5px', lineHeight: 1 }}>2024</p>
                <p style={{ fontSize: '0.9rem', fontWeight: 500 }}>Founded with a passion for purity.</p>
              </div>
            </div>
          </motion.div>
...
const Ambience = () => {
  return (
    <section id="ambience" className="section-padding">
      <div className="container">
        <div style={{ textAlign: 'center', maxWidth: '700px', margin: '0 auto 60px' }}>
          <motion.span initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} className="section-subtitle">Architecture & Ambience</motion.span>
          <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} className="section-title">A Space Designed for Tranquility</motion.h2>
          <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} style={{ color: 'var(--muted)', fontSize: '1.1rem' }}>
            Every corner of Hotel Aalayaa is crafted to reflect the harmony between nature and modern comfort. Step into a world where premium dining meets mindful design.
          </motion.p>
        </div>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '30px' }}>
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }} style={{ gridColumn: '1 / -1', height: '400px', borderRadius: '24px', overflow: 'hidden', position: 'relative' }}>
            <img src="https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&q=80&w=1200" alt="Main Ambience" loading="lazy" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to top, rgba(0,0,0,0.8), transparent)', display: 'flex', alignItems: 'flex-end', padding: '40px' }}>
              <h3 className="font-playfair" style={{ color: 'white', fontSize: '2rem' }}>The Grand Dining Hall</h3>
            </div>
          </motion.div>
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} style={{ height: '300px', borderRadius: '24px', overflow: 'hidden', position: 'relative' }}>
            <img src="https://images.unsplash.com/photo-1550966871-3ed3cdb5ed0c?auto=format&fit=crop&q=80&w=800" alt="Dining Detail" loading="lazy" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            <div style={{ position: 'absolute', bottom: '20px', left: '20px', background: 'rgba(255,255,255,0.9)', padding: '8px 16px', borderRadius: '8px', fontWeight: 600 }}>Intimate Seating</div>
          </motion.div>
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} style={{ height: '300px', borderRadius: '24px', overflow: 'hidden', position: 'relative' }}>
            <img src="https://images.unsplash.com/photo-1559339352-11d035aa65de?auto=format&fit=crop&q=80&w=800" alt="Lighting" loading="lazy" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            <div style={{ position: 'absolute', bottom: '20px', left: '20px', background: 'rgba(255,255,255,0.9)', padding: '8px 16px', borderRadius: '8px', fontWeight: 600 }}>Warm Lighting</div>
          </motion.div>
        </div>
      </div>
    </section>
          ...
          {categories.map(cat => (
            <button
              ...
              style={{
                ...
                fontWeight: 500,
                transition: 'all 0.3s',
                backgroundColor: activeCat === cat ? 'var(--primary)' : 'white',
                color: activeCat === cat ? 'white' : 'var(--text)',
                border: `1px solid ${activeCat === cat ? 'var(--primary)' : '#e5e7eb'}`,
          ...
          <AnimatePresence>
            {filteredMenu.map(item => (
              <motion.div
                ...
                key={item.id}
                style={{ backgroundColor: 'white', borderRadius: '20px', overflow: 'hidden', boxShadow: 'var(--shadow-md)', transition: 'transform 0.3s' }}
              ...
              >
                <div style={{ position: 'relative', height: '220px', overflow: 'hidden' }}>
                  ...
                  <div style={{ position: 'absolute', top: '16px', right: '16px', background: 'white', padding: '6px 12px', borderRadius: '99px', fontWeight: 700, color: 'var(--primary)' }}>
                    {item.price}
                  </div>
                </div>
                <div style={{ padding: '24px' }}>
                  ...
                  <h3 className="font-playfair" style={{ fontSize: '1.3rem', marginBottom: '10px' }}>{item.name}</h3>
...
const EventsAndCatering = () => {
  const events = [
    ...
    { id: 4, title: "Bulk Food Orders", desc: "High-quality bulk food orders customized for your specific requirements.", img: "https://images.unsplash.com/photo-1547496502-affa22d38842?auto=format&fit=crop&q=80&w=800", btn: "Contact for Bulk Orders" }
  ];
...
const Stats = () => {
  ...
  return (
    <section style={{ backgroundColor: 'var(--secondary)', color: 'white', padding: '80px 0' }}>
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 150px), 1fr))', gap: '40px', textAlign: 'center' }}>
          {stats.map((stat, idx) => (
            <motion.div key={idx} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: idx * 0.1 }}>
              <div className="font-playfair" style={{ fontSize: '3.5rem', color: 'var(--primary)', marginBottom: '10px' }}>
                <CountUp end={stat.value} duration={2.5} enableScrollSpy scrollSpyOnce />
                {stat.suffix}
              </div>
              <div style={{ fontSize: '1.1rem', color: 'rgba(255,255,255,0.8)' }}>{stat.label}</div>
            </motion.div>
          ))}
        </div>
      </div>
    ...
    <section id="gallery" className="section-padding">
      <div className="container">
        <div style={{ textAlign: 'center', maxWidth: '700px', margin: '0 auto 50px' }}>
          ...
          <h2 className="section-title">Visual Symphony</h2>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 300px), 1fr))', gap: '20px' }}>
          {galleryImages.map((src, idx) => (
            <motion.div
              ...
              style={{ borderRadius: '16px', overflow: 'hidden', height: idx % 2 === 0 ? '350px' : '250px', cursor: 'pointer' }}
            >
              <img src={src} alt="Gallery item" loading="lazy" style={{ width: '100%', height: '100%', objectFit: 'cover', transition: 'transform 0.4s' }} onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.1)'} onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1)'} />
            </motion.div>
          ))}
        </div>
      </div>
...
const Footer = () => {
  return (
    <footer style={{ backgroundColor: 'var(--surface-dark)', color: 'white', paddingTop: '80px', paddingBottom: '30px' }}>
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 250px), 1fr))', gap: '50px', marginBottom: '60px' }}>
          <div>
            <img src="/assets/logo-aalayaa.png" alt="Logo" loading="lazy" style={{ height: '60px', marginBottom: '24px', filter: 'brightness(0) invert(1)' }} />
            ...
            <div style={{ display: 'flex', gap: '16px' }}>
              <a href="#" style={{ color: 'white', background: 'rgba(255,255,255,0.1)', width: '40px', height: '40px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold' }}>Fb</a>
              <a href="#" style={{ color: 'white', background: 'rgba(255,255,255,0.1)', width: '40px', height: '40px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold' }}>Ig</a>
              <a href="#" style={{ color: 'white', background: 'rgba(255,255,255,0.1)', width: '40px', height: '40px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold' }}>Tw</a>
            </div>
          </div>
          
          <div>
            <h4 style={{ fontSize: '1.2rem', marginBottom: '24px', fontWeight: 600 }}>Quick Links</h4>
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '12px', color: 'rgba(255,255,255,0.7)' }}>
              <li><a href="#home" style={{ transition: 'color 0.2s' }} onMouseEnter={e => e.target.style.color='var(--primary)'} onMouseLeave={e => e.target.style.color='rgba(255,255,255,0.7)'}>Home</a></li>
              <li><a href="#about" style={{ transition: 'color 0.2s' }} onMouseEnter={e => e.target.style.color='var(--primary)'} onMouseLeave={e => e.target.style.color='rgba(255,255,255,0.7)'}>About Us</a></li>
              <li><a href="#menu" style={{ transition: 'color 0.2s' }} onMouseEnter={e => e.target.style.color='var(--primary)'} onMouseLeave={e => e.target.style.color='rgba(255,255,255,0.7)'}>Our Menu</a></li>
              <li><a href="#gallery" style={{ transition: 'color 0.2s' }} onMouseEnter={e => e.target.style.color='var(--primary)'} onMouseLeave={e => e.target.style.color='rgba(255,255,255,0.7)'}>Gallery</a></li>
            </ul>
          </div>
              ...
              <div style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  {config.hotel.locations.map((loc, idx) => (
                    <div key={idx}>
                      <div style={{ fontWeight: 600, color: 'white', marginBottom: '4px', fontSize: '0.95rem' }}>{loc.name}</div>
                      <a href={loc.link} target="_blank" rel="noopener noreferrer" style={{ transition: 'color 0.2s', fontSize: '0.9rem' }} onMouseEnter={e => e.target.style.color='var(--primary)'} onMouseLeave={e => e.target.style.color='rgba(255,255,255,0.7)'}>
                        {loc.address}
                      </a>
                    </div>
                  ))}
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '30px', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', color: 'rgba(255,255,255,0.5)', fontSize: '0.9rem' }}>
